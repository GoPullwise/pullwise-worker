...
""".strip(),
    ...
    def test_ci_dependency_bounds_match_supported_python_runtimes(self) -> None:
        ...
        self.assertIn("\"pip-audit>=2.9,<2.10; python_version < '3.10'\"", workflow)
        self.assertIn("\"pip-audit>=2.10.1,<2.11; python_version >= '3.10'\"", workflow)
        self.assertIn("\"filelock>=3.19.1,<3.20; python_version < '3.10'\"", workflow)
        self.assertIn("\"filelock>=3.20.3,<4; python_version >= '3.10'\"", workflow)
