...
- `generated_file_exceptions` is a closed exact exception, not a wildcard or
  ...
  provenance
  `pullwise-server@06ed22299e324a8a39f9030c653aef34044c3d3e:pullwise_server/agent_first_contract_bundle_python.py`,
  8062 physical lines, and SHA-256
  `bd099dd825c2b2340061b67500bc02f1bb4fee0a1ce7ff44138b36b8821a59fd`.
...
- D41 (`ccfa987beb48b1158a0122b13ed6bab40bd955e5142fbd1e0fc56f7151b1cca5`)
  ...
  Python/Node parity all passed. The exactly-one Generate allowance is consumed
  at count `1` by package `@pullwise/agent-task-contract@0.1.0`, content
