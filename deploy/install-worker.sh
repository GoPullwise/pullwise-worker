...
write_env_value PULLWISE_WORKER_MAX_CLAIM_JOBS "${PULLWISE_WORKER_MAX_CLAIM_JOBS:-2}"
...
write_env_value PULLWISE_REVIEW_CALIBRATION_MODE "shadow"
write_env_value PULLWISE_REVIEW_CALIBRATION_MODEL "relative_factor"
write_env_value PULLWISE_REVIEW_CALIBRATION_HALF_LIFE_DAYS "45"
write_env_value PULLWISE_REVIEW_CALIBRATION_MIN_EFFECTIVE_SAMPLES "20"
write_env_value PULLWISE_REVIEW_CALIBRATION_ENABLE_BUCKETS "false"
write_env_value PULLWISE_REVIEW_CALIBRATION_ENABLE_HIERARCHY "false"
write_env_value PULLWISE_REVIEW_CALIBRATION_ENABLE_DRIFT "false"
write_env_value PULLWISE_REVIEW_CALIBRATION_SAMPLE_AUDIT_RATE "0.02"
write_env_value PULLWISE_REVIEW_CALIBRATION_BORDERLINE_SAMPLE_WINDOW "0.03"
