...
有 18 个 pending、8 个 resolved（D1、D3-D8、D27），唯一 active decision 是 D9。S3 blockers 保持 D11、
...
- decision register 为 `valid_pending`，18 个 pending、8 个 resolved，S2 无 blocker；
  D3-D8 与 D27 已解决，active decision D9；S3 blockers 为 D11、D15、D16、D17，S4 blockers
  为 D9–D17。
