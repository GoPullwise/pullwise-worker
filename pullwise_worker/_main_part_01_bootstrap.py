...
REPOSITORY_MIRROR_CACHE_DIR_NAME = ".pullwise-repo-cache"
_REPO_CACHE_DIR_NAME = REPOSITORY_MIRROR_CACHE_DIR_NAME
_CHECKOUT_RUNTIME_DIR_NAMES: set[str] = {_REPO_CACHE_DIR_NAME}
