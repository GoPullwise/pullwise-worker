...
from .agent_kernel_current_requirement_migrations import (
    CURRENT_REQUIREMENT_TABLES,
    MIGRATION_5,
    MIGRATION_5_SHA256,
)
from .agent_kernel_current_terminalization_migrations import (
...
from .agent_kernel_current_transport_migrations import (
    CURRENT_TRANSPORT_TABLES,
    MIGRATION_8,
    MIGRATION_8_SHA256,
)
from .agent_kernel_current_debug_migrations import (
...
TERMINAL_COMMIT_SCHEMA_VERSION = 7
TRANSPORT_SCHEMA_VERSION = 8
...
CURRENT_TABLES = CURRENT_TABLES | CURRENT_TRANSPORT_TABLES
CURRENT_TABLES = CURRENT_TABLES | CURRENT_DEBUG_TABLES
